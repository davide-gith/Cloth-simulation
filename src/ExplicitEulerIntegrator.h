#ifndef EXPLICIT_EULER_SIMULATOR_H
#define EXPLICIT_EULER_SIMULATOR_H
...
class ExplicitEulerIntegrator : public IClothSimulator {
public:
	ExplicitEulerIntegrator(ClothData* data);
